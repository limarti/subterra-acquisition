        ...
        <MasonryGrid class="masonry-cols-1 @xl:masonry-cols-2">
          ...
          <Card :title="$t('settings.user_preferences.title')">
            <div class="flex flex-col rounded-b-sm p-4 gap-2">
              ...
              <!-- Units button -->
              <div class="w-full">
                <button class="flex items-center cursor-pointer justify-between w-full px-3 py-2 rounded-md border" @click="() => open(UnitsDialog)">
              ...
              <!-- Language button -->
              <div class="w-full">
                <button class="flex items-center cursor-pointer justify-between w-full px-3 py-2 rounded-md border" @click="() => open(LanguageDialog)">
                  <div class="flex items-center gap-2 text-gray-200">
                    <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
